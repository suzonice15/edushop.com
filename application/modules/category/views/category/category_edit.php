			...
			<form method="POST" action="<?= base_url('category-update') ?>" enctype="multipart/form-data">
				<div class="box-body">
					<div class="form-group <?= form_error('category_title') ? 'has-error' : '' ?>">
						...
						<input type="text" class="form-control the_title" id="category_title" name="category_title"
					...
					<div class="form-group <?= form_error('category_name') ? 'has-error' : '' ?>">
						...
						<input type="text" class="form-control the_name" id="category_name" name="category_name"
					...
					<div  class="form-group featured-image">
						<label>Mobile category Image <span class="required">Size(300 * 300)</span></label>
						<?php
