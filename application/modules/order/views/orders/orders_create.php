						...
						<div class="box box-danger" style="border:2px solid #ddd">
							...
							<div class="box-body">
								...
								<div class="form-group ">
									...
									<input name="customer_email"  type="text" class="form-control"  id="user_email" value="" />
...
<span id="customer_phone_error" style="color:red"></span>
								...
								<div  hidden class="checkbox">
									<label>
										<input hidden type="checkbox" name="ship_to_billing" id="ship_to_billing" value="1">
										<b hidden class="fgreen">Same as Customer Address </b>
									</label>
								</div>
						...
						<div class="box box-primary" style="border:2px solid #ddd">
							...
							<div class="box-body">
								<div  hidden class="form-group" id="order_area">
									<label>
										<input type="radio" name="insited" value="inside_dhaka" id="inside_dhaka" checked > Inside Dhaka
									</label>
									<br/>
									<label>
										<input type="radio" name="insited" id="outside_dhaka" value="outside_dhaka"> Outside Dhaka
									</label>
								</div>
