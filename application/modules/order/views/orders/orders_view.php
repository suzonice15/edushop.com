                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="box box-primary" style="border:2px solid #ddd">
                                        <div class="box-header" style="background-color: #ddd;">
                                            ...
                                            <a href="javascript:void(0)" class="pull-right change_order_data address_change">Change</a>
                                        </div>
                                        <div class="box-body">
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <p><b>District:</b> <?=get_district($order->order_area) ?></p>
                                                        <p><b>Upazila:</b> <?=$order->thana;?></p>
										...
										<div class="form-group ">
                                            ...
                                            <input type="text" name="customer_phone" class="form-control"
                                                   value="<?php echo $order->customer_phone; ?>"/>
                                                	...
                                                	<div class="form-group ">
                                                        <label for="billing_email">Distict</label>
                                                        <input readonly type="text"  class="form-control"
                                                               value="<?=get_district($order->order_area) ?>"/>
                                                    </div>
                                                	<div   class="form-group ">
                                                        <label for="billing_email">Upazila</label>
                                                        <input readonly type="text"  class="form-control"
                                                               value="<?php echo $order->thana; ?>"/>
                                                    </div>
                                ...
                                <div class="col-md-5">
                                    <div class="box box-danger" style="border:2px solid #ddd">
                                        ...
                                        <div class="box-footer">
                                         ...
                                         <a href="<?php echo base_url()?>order-list" class="btn btn-success">Back</a>
                                            <?php } else {
								...
								<select name="products[items][' . $product_id . '][Color]"  id="productSize" class="form-control item_color" >';
                                          ...
                                          $html .='<input type="hidden" class="shipping_charge_in_dhaka"
                                                       ...
                                                       value="'.get_product_delevery_price_out_dhaka($product_id).'"><input type="hidden" name="product_id[]" value="'.$product_id.'"><input type="hidden" name="quantity[]" value="' . (isset($item['qty']) ? $item['qty'] : null) . '"><input type="hidden" name="product_price[]" value="' . (isset($item['subtotal']) ? $item['subtotal'] : null) . '">';
