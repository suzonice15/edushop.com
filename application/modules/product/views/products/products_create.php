<div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <div class="box box-primary" style="border: 2px solid #ddd;">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div hidden class="form-group <?= form_error('product_video') ? 'has-error' : '' ?>">
                                ...
                                <div class="box box-primary" style="border: 2px solid #ddd;height: 550px">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group featured-image">
                                            ...
                                            <input type="hidden" placeholder="Enter image Permalink" class="form-control"
                                                   name="featured_image_link"
                                                   value="<?php echo set_value('featured_image_link'); ?>"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <input placeholder="Enter image Permalink" type="hidden"
                                                       class="form-control" name="product_image1_link"
                                                       value="<?php echo set_value('product_image1_link'); ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <input   placeholder="Enter image Permalink" type="hidden" class="form-control"
                                                   name="product_image2_link" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <input  placeholder="Enter image Permalink" type="hidden" class="form-control"
                                                   name="product_image3_link"
                                                   value="<?php echo set_value('product_image3_link'); ?>"/>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <input   placeholder="Enter image Permalink" type="hidden" class="form-control"
                                                     name="product_image4_link"
                                                     value="<?php echo set_value('product_image4_link'); ?>"/>
    ...
    <div class="box box-primary" style="border: 2px solid #ddd;">
        ...
        <div class="box-body">
            <div class="form-group ">
                <textarea class="form-control textarea" rows="3" name="product_summary" id="product_summary"> </textarea>
            </div>
        </div>
    </div>
    <div class="box box-primary" style="border: 2px solid #ddd;">
    ...
    <div  hidden class="box box-primary" id="specification" style="border:1px solid #ddd ;margin-bottom: 39px;">
        <div class="box-header" style="background-color: #ddd">
