...
<div class="box box-success">
					...
					<div class="col-md-5">
						<div class="box box-primary" style="border: 2px solid #ddd;" >
							...
							<div class="box-body">
								...
								<div  hidden class="col-sm-6 ">
									<div class="form-group <?=form_error('discount_to') ? 'has-error' : ''?>">
										...
										<div class="input-group date">
											...
											<input type="text" class="form-control withoutFixedDate " name="discount_date_to" id="discount_from" value="<?php  if($product->discount_date_to >0000-00-00) { echo  date('d-m-Y',strtotime($product->discount_date_to));} else {  }   ?>">
								...
								<div   class="form-group <?=form_error('product_stock') ? 'has-error' : ''?>">
									<label for="product_stock">Stock Qty.</label>
									<input type="text" class="form-control" name="product_stock" id="product_stock" value="<?php if(isset($product)) { echo $product->product_stock;}?>">
								</div>
	...
	<select name="product_type" class="form-control">
								...
								<div class="form-group featured-image">
									...
									<div class="row">
										...
										<div class="col-sm-11">
											...
											<input type="hidden" class="form-control" name="featured_image_link"/>
										</div>
									</div>
								</div>
									...
									<div class="row">
										...
										if(isset($gallery[0]))
										{
											...
											<div class="col-sm-11">
												...
												<input type="hidden" class="form-control" name="product_image1_link"/>
											</div><?php
										}
										else
										{
									...
									<div class="row">
										...
										if(isset($gallery[1]))
										{
											...
											<div class="col-sm-11">
												...
												<input type="hidden" class="form-control" name="product_image2_link"/>
											</div><?php
										}
										else
										{
									...
									<div class="row">
										...
										if(isset($gallery[2]))
										{
											...
											<div class="col-sm-11">
												...
												<input type="hidden" class="form-control" name="product_image3_link"/>
											</div><?php
										}
										else
										{
									...
									<div class="row">
										...
										if(isset($gallery[3]))
										{
											...
											<div class="col-sm-11">
												...
												<input type="hidden" class="form-control" name="product_image4_link"/>
											</div><?php
										}
										else
										{
			...
			-->
				...
				<div class="box-body">
					<div class="form-group ">
						<textarea  class="form-control textarea " rows="10" name="product_summary" id="product_summary"><?php if(isset($product)) : echo  $product->product_summary;endif ; ?> </textarea>
					</div>
				</div>
			</div>
			...
			<div class="box box-primary" style="border: 2px solid #ddd;" >
				...
				<div hidden class="box box-primary"  style="border:2px solid #ddd" id="specification">
				<div class="box-header" style="background-color: #ddd"
				>
