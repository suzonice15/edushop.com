<div class="box-body">
	...
	<div class="form-group "><label for="media_title">Phone</label>
		<input
			type="text" id="customer_phone"  class="form-control" name="user_phone"  value="<?php if(isset($user)) { echo $user->user_phone;}?>"	>
