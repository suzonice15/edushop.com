		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			if($userType =='super-admin' ||  $userType =='admin'  ){
			 ...
			 <i class="fa fa-angle-left pull-right"></i>
					...
					<ul class="treeview-menu">
						...
						<li  ><a href="<?php echo base_url(); ?>category-create">
								<i class="fa fa-arrow-circle-o-right"></i> Add Category </a>
						</li>



						<li><a href="<?php echo base_url(); ?>category-list">
								<i class="fa fa-arrow-circle-o-right"></i> All Categories </a>
						</li>
					</ul>
				</li>
			<?php } ?>
			...
			if($userType =='super-admin' ||  $userType =='admin'  ){
			 ...
			 <i class="fa fa-angle-left pull-right"></i>
					...
					<ul class="treeview-menu">
						<li><a href="<?php echo base_url(); ?>product/LimitedController/stock">
								<i class="fa fa-arrow-circle-o-right"></i>  Stock Report </a>
						</li>
						<li><a href="<?php echo base_url(); ?>profit/ProfitController/index">
								<i class="fa fa-arrow-circle-o-right"></i>  Profit Report </a>
						</li>
							<li  ><a href="<?php echo base_url(); ?>order/OrderReportController/report">
							<i class="fa fa-arrow-circle-o-right"></i> Orders Report </a>
					</li>
					<li><a href="<?php echo base_url(); ?>order/OrderReportController/sellProduct">
							<i class="fa fa-arrow-circle-o-right"></i> Product Sell Report </a>
					</li>
					</ul>
				</li>
			<?php } ?>
			...
			<li class="treeview">
			 ...
			 <i class="fa fa-angle-left pull-right"></i>
				...
				<ul class="treeview-menu">
					...
					<li hidden ><a href="<?php echo base_url(); ?>add-list">
							<i class="fa fa-arrow-circle-o-right"></i> Ads </a>
					</li>
					<li hidden ><a href="<?php echo base_url(); ?>picture-delete">
