            ...
            <div id="primary" class="content-area">
                <main id="main" class="site-main">
                    ...
                    <header class="woocommerce-products-header">
                        ...
                        <h3 class="section-heading mobile_category_heading_title sh-t6 sh-s3 mtab-main-term-2 main-term-2 multi-tab bs-pretty-tabs bs-pretty-tabs-initialized">

                            <a href="javascript:void(0)" data-toggle="tab" aria-expanded="true"
                               class="main-link main_carosel_category_link">
                                <span class="h-text main-term-2"><?= $breadcumb_category ?> </span>
                            </a>
