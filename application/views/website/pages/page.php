<style>
	...
	@media (max-width: 776px) {
		.mobile_page_responsive{ margin-top: 92px !important;}
	}
	.mobile_page_responsive{ margin-top: 35px}

</style>


<div class="mobile_page_responsive container container-fullwidth" style="margin-bottom: 50px">
