                                ...
                                <div class="card-header">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-md-3 col-lg-3  col-12  home_print_mobile_class" style="padding: 2px;">
                                            ...
                                            <a href="<?php echo base_url();?>home/orderPrint/<?php echo $order->order_id; ?>" class="btn btn-info  d-print-none">
                                ...
                                <div class="card-body">
                                    <div class="cart-info">
                                        ...
                                        <table class="table   table-bordered">
                                            ...
                                            <tr>
                                                <td style="75%">
                                                    <span class="extra bold totalamout"><b>District</span>
                                                </td>
                                                <td class="text-right" style="width:50%">
                                                    <span
                                                        class="bold totalamout"><b><?=get_district($order->order_area )?></b></span>
                                                </td>
                                            </tr>
                                            <tr>
                                            <tr>
                                                <td style="75%">
                                                    <span class="extra bold totalamout"><b>Sub area</span>
                                                </td>
                                                <td class="text-right" style="width:50%">
                                                    <span
                                                        class="bold totalamout"><b><?= $order->thana ?></b></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="75%">
                                        ...
                                        <table class="table  table-bordered">
                                            ...
                                            <tr >
                                                ...
                                                <td colspan="2">
                                                    <span class="extra bold totalamout"><b>Delivery Cost(<?= get_option('delevery_check_out') ?>)</b></span>
                                                </td>
